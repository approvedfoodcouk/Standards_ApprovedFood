...
This list is generated by a _Grunt_ build task when preparing a release with the log including auto-generated links to related commits. Of course you can edit this change log before actual release, but it forms the basis of the log.

### Provide more information when browsing the history
These messages are examples of *bad commit messages*. Avoid these type of commit, it's simply a waste of time:
* more stuff
