 ...
 */
class ApprovedFood_Sniffs_Commenting_TodoWithBugtrackerLinkSniff implements PHP_CodeSniffer_Sniff
{
    /**
  ...
  public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
  {
      ...
      if (preg_match('|[^a-z]+todo[^a-z]+(.*)|i', $content, $matches) !== 0) {
        ...
        if (false === strpos($todoMessage, 'https://github.com/approvedfoodcouk/af_web/issues/') or
           false === strpos($todoMessage, 'https://github.com/approvedfoodcouk/bugs/')) {
