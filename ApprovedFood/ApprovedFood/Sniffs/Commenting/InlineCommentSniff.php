 ...
 */
class ApprovedFood_Sniffs_Commenting_InlineCommentSniff implements PHP_CodeSniffer_Sniff {
    /**
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr) {
        ...
        // Allow standard '//end' prefix
        if (substr($comment, 0, 5) === '//end') {
            return;
        }
        ...
        if (strlen($comment) > $slashCount and $spaceCount === 0) {
            ...
            $phpcsFile->addWarning($error, $stackPtr, 'NoSpaceBefore', $data);
        }
